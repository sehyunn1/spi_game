...
handle = cylinder( size=vec(7, 2, 2), color=color.white , pos=vec(-10, 0, 0 ))
head = box( size=vec(2.5, 5, 3), pos=vec(-10, 0, 0), color=color.red)
hammer = compound( [handle, head] )
hammer.axis = vec(3,0,0)
sphere(pos=vec(-10, 4, 0), radius=2.5, color=color.red)
sphere(pos=vec(-10, -4, 0), radius=2.5, color=color.red)
